...
class HixlClient {
 ...
 private:
  Status SendCtrlMsg(int32_t fd, CtrlMsgType msg_type) const;
  Status RecvCtrlMsg(int32_t fd, CtrlMsgType expected_type, std::string &json_str, uint32_t timeout_ms) const;
