...
constexpr const int LIMIT_THREAD_NUM_MIN = 1;
constexpr const int LIMIT_THREAD_NUM_MAX = 64;
constexpr const int LIMIT_TASK_QUEUE_CAPACITY_MIN = 1;
constexpr const int LIMIT_TASK_QUEUE_CAPACITY_MAX = 65535;
