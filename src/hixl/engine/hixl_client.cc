...
Status HixlClient::Initialize(const std::vector<EndpointConfig> &local_endpoint_list) {
  ...
  HIXL_CHK_STATUS_RET(CtrlMsgPlugin::Connect(server_ip_, server_port_, ctrl_socket_, kCtrlMsgPluginTimeoutMs),
  ...
  HIXL_CHK_STATUS_RET(RecvEndpointInfoResp(ctrl_socket_, remote_endpoint_list),
