...
#define HIXL_PROF_TYPE_START_OFFSET 0x009000U
...
#ifndef MSPROF_REPORT_ACL_OTHERS_BASE_TYPE
#define MSPROF_REPORT_ACL_OTHERS_BASE_TYPE 0x040000U
#endif

namespace hixl {
enum class HixlProfType {
  // start with 0x0C0000U
  kProfTypeStart = MSPROF_REPORT_ACL_OTHERS_BASE_TYPE + HIXL_PROF_TYPE_START_OFFSET,
  HixlOpBatchRead,
  HixlOpBatchWrite,
  kProfTypeEnd
};
