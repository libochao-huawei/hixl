...
class HostRegisterProxy {
 public:
  ...
  static std::shared_ptr<HostRegisterProxy> GetInstance(int32_t dev_phy_id);

  static Status RegisterByDev(int32_t dev_phy_id, void *host_addr, uint64_t size, void *&device_addr);

  static Status UnregisterByDev(int32_t dev_phy_id, void *host_addr);
   ...
   */
  static Status GetRegisteredDeviceAddrByDev(int32_t dev_phy_id, void *host_addr, void *&device_addr);
