...
__attribute__((weak)) HcclResult HcommChannelFence(ChannelHandle channel);
__attribute__((weak)) HcclResult HcommWriteNbi(ChannelHandle channel, void *dst, const void *src, uint64_t len);
__attribute__((weak)) HcclResult HcommReadNbi(ChannelHandle channel, void *dst, const void *src, uint64_t len);
