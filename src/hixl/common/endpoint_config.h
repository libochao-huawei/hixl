...
#ifndef CANN_HIXL_SRC_HIXL_COMMON_ENDPOINT_CONFIG_H_
#define CANN_HIXL_SRC_HIXL_COMMON_ENDPOINT_CONFIG_H_
...
#endif  // CANN_HIXL_SRC_HIXL_COMMON_ENDPOINT_CONFIG_H_
