...
#ifndef HIXL_SRC_LLM_DATADIST_TRANSFER_ENGINE_HCCL_TRANSFER_ENGINE_H_
#define HIXL_SRC_LLM_DATADIST_TRANSFER_ENGINE_HCCL_TRANSFER_ENGINE_H_
...
class HcclTransferEngine : public TransferEngine {
 public:
  HcclTransferEngine(uint64_t cluster_id) : TransferEngine(cluster_id) {};
  ~HcclTransferEngine() override;
...
#endif  // HIXL_SRC_LLM_DATADIST_TRANSFER_ENGINE_HCCL_TRANSFER_ENGINE_H_
