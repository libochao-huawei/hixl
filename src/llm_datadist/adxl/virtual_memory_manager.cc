...
constexpr size_t kDefaultNumBlocks = 64UL;
constexpr size_t kDefaultGlobalVirtualMemorySize = kBytesPerTB * kDefaultNumBlocks;
constexpr size_t kDefaultGlobalStartAddrTB = 40UL;
...
Status VirtualMemoryManager::ReserveMemAddress(void *&virtual_address, size_t size) {
  const uintptr_t start_va = (global_start_va_ != 0) ? global_start_va_ : kDefaultGlobalStartAddrTB * kBytesPerTB;
