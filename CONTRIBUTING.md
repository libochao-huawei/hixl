...
1. 提交PR时，请按照[PR模板](.gitcode/PULL_REQUEST_TEMPLATE.zh-CN.md)仔细填写本次PR的业务背景、目的、方案等信息。
2. 使用git进行代码提交前，可以参考[pre-commit工具使用说明](docs/guidelines/precommit_guide.md)来使您的代码提交更合规高效。
