...
| --- | --- | --- |
| remote_engine | 输入 | 远端HIXL的唯一标识。 |
| status | 输出 | 异步连接状态，枚举值如下。<br><br>-  NOT_CONNECT<br>-  CONNECT_PENDING<br>-  CONNECTING<br>-  CONNECTED<br>-  CONNECT_FAILED<br>-  DISCONNECT_PENDING<br>-  DISCONNECTING |
...
| 参数名称 | 输入/输出 | 取值说明 |
| --- | --- | --- |
| status_map | 输出 | 存储所有异步建链断链任务的状态，枚举值如下。<br><br>-  NOT_CONNECT<br>-  CONNECT_PENDING<br>-  CONNECTING<br>-  CONNECTED<br>-  CONNECT_FAILED<br>-  DISCONNECT_PENDING<br>-  DISCONNECTING |
