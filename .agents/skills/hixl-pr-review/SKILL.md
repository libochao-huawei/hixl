...
C++ 安全编码规范检查（参考文件 [cpp-general.md](./references/cpp-secure.md)）

C++ 代码风格规范检查（参考文件 [cpp-general.md](./references/cpp-style.md)）
...
Python 安全编码规范检查（参考文件 [cpp-general.md](./references/python-secure.md)）
...
> 依据 [cpp-general.md](./references/cpp-secure.md) 中的“规范列表”
...
> 依据 [cpp-general.md](./references/cpp-style.md) 中的“规范列表”
...
> 依据 [cpp-general.md](./references/python-secure.md) 中的“规范列表”
...
询问用户是否需要将检视报告内容发布到评论，如果需要，使用 GitCode API：
