...
if(hcomm_FOUND)
    set(hcomm_INCLUDE_DIR "${_INCLUDE_DIR}")
    include(CMakePrintHelpers)
    message(STATUS "Variables in hcomm module:")
    cmake_print_variables(hcomm_INCLUDE_DIR)
    ...
    if (EXISTS "${hcomm_INCLUDE_DIR}/../pkg_inc/hccl")
        set_target_properties(hcomm_headers PROPERTIES
            INTERFACE_INCLUDE_DIRECTORIES "${hcomm_INCLUDE_DIR};${hcomm_INCLUDE_DIR}/hccl;${hcomm_INCLUDE_DIR}/../pkg_inc;${hcomm_INCLUDE_DIR}/../pkg_inc/hccl"
        )
    else ()
        set_target_properties(hcomm_headers PROPERTIES
            INTERFACE_INCLUDE_DIRECTORIES "${hcomm_INCLUDE_DIR};${hcomm_INCLUDE_DIR}/hccl"
        )
    endif ()
