...
// Helper: run push-with-range scenarios (STest variant)
static void RunPushScenariosSt(LlmDataDist &p, const Cache &src, const CacheIndex &dst_idx) {
...
// Helper: run pull-with-range scenarios (STest variant)
static void RunPullScenariosSt(LlmDataDist &d, const CacheIndex &cache_idx, Cache &dst) {
  KvCacheExtParam ext_param = {};
...
TEST_F(LlmDataDistSTest, TestPushWithRangeAndTensorNumV2) {
  ...
  RunPushScenariosSt(llm_datadist_p, src_cache, dst_idx);
...
TEST_F(LlmDataDistSTest, TestPullWithRangeAndTensorNumV2) {
  ...
  RunPullScenariosSt(llm_datadist_d, cache_idx, dst_cache);
