...
class DataCacheEngineTest : public ::testing::Test {
 ...
 private:
  ...
  llm::HcclTransferEngine transfer_engine_;
};
...
TEST_F(DataCacheEngineTest, MemPoolConfigExceedsMaxSize) {
  std::map<ge::AscendString, ge::AscendString> options;
  options[llm::LLM_OPTION_MEM_POOL_CONFIG] = "{\"memory_size\": 138547331072}";
  EXPECT_EQ(cache_engine_.Initialize(options), ge::LLM_PARAM_INVALID);
}
