...
class AdxlEngineUTest : public ::testing::Test {
 protected:
  void ClearStatisticChannels() {
    StatisticManager::GetInstance().RemoveChannel(kEngine1Id);
    StatisticManager::GetInstance().RemoveChannel(kEngine1PortId);
    StatisticManager::GetInstance().RemoveChannel(kEngine2Id);
    StatisticManager::GetInstance().RemoveChannel(kEngine3Id);
  }
