...
TEST_F(EvictionTest, TestEvictionWithTransfer) {
  ...
  llm::AutoCommResRuntimeMock::SetDevice(2);
  Hixl engine3;
  EXPECT_EQ(engine2.Initialize("127.0.0.1:26002", options_), SUCCESS);

  llm::AutoCommResRuntimeMock::SetDevice(3);
  Hixl engine4;
  EXPECT_EQ(engine2.Initialize("127.0.0.1:26003", options_), SUCCESS);

  llm::AutoCommResRuntimeMock::SetDevice(4);
  Hixl engine5;
  EXPECT_EQ(engine2.Initialize("127.0.0.1:26004", options_), SUCCESS);
