...
#ifndef CANN_HIXL_TESTS_CPP_HIXL_UBMEM_UBMEM_TEST_UTILS_H_
#define CANN_HIXL_TESTS_CPP_HIXL_UBMEM_UBMEM_TEST_UTILS_H_
...
inline int32_t AllocateUbMemTestPort() {
...
#endif  // CANN_HIXL_TESTS_CPP_HIXL_UBMEM_UBMEM_TEST_UTILS_H_
