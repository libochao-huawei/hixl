...
rtError_t rtMemSetPidToShareableHandleV2(const void *shareableHandle, rtMemSharedHandleType type,
                                         int *pid, uint32_t count) {
  return llm::RuntimeStub::GetInstance()->rtMemSetPidToShareableHandleV2(shareableHandle, type, pid, count);
}
