...
- 安装**pytorch**与**torch_npu**包
  ...
  根据使用的python版本，参照[版本配套说明](https://gitcode.com/Ascend/pytorch)，下载安装对应版本的`pytorch`和`torch_npu`，安装方法请参考[软件安装指南](https://gitcode.com/Ascend/pytorch/blob/v2.7.1/docs/zh/installation_guide/menu_installation_guide.md)，下面给出python 3.9的配套版本的`pytorch、torch_npu`及其安装方式，其他版本参考版本配置说明和安装指导。
  
  | PyTorch版本 | torch_npu插件版本 | Python版本 | 系统架构 | CANN版本 | 安装方式        | 安装命令                                                     |
  | ----------- | ----------------- | ---------- | -------- | -------- | --------------- | ------------------------------------------------------------ |
  | 2.7.1       | 26.0.0            | Python 3.9 | AArch64  | 9.0.0    | 离线安装（Whl） | # 下载并安装PyTorch框架 wget [https://download.pytorch.org/whl/cpu/torch-2.7.1%2Bcpu-cp39-cp39-manylinux_2_28_aarch64.whl](https://link.gitcode.com/?target=https%3A%2F%2Fdownload.pytorch.org%2Fwhl%2Fcpu%2Ftorch-2.7.1%2Bcpu-cp39-cp39-manylinux_2_28_aarch64.whl&from=https%3A%2F%2Fgitcode.com%2FAscend%2Fpytorch%2Fblob%2Fv2.7.1%2Fdocs%2Fzh%2Finstallation_guide%2Finstallation_via_binary_package.md&lang=zh&theme=white) pip3 install torch-2.7.1+cpu-cp39-cp39-manylinux_2_28_aarch64.whl  # 下载并安装torch_npu插件 wget https://gitcode.com/Ascend/pytorch/releases/download/v26.0.0-pytorch2.7.1/torch_npu-2.7.1.post4-cp39-cp39-manylinux_2_28_aarch64.whl pip3 install torch_npu-2.7.1.post4-cp39-cp39-manylinux_2_28_aarch64.whl |
  | 2.7.1       | 26.0.0            | Python 3.9 | X86_64   | 9.0.0    | 离线安装（Whl） | # 下载并安装PyTorch框架 wget [https://download.pytorch.org/whl/cpu/torch-2.7.1%2Bcpu-cp39-cp39-manylinux_2_28_x86_64.whl](https://link.gitcode.com/?target=https%3A%2F%2Fdownload.pytorch.org%2Fwhl%2Fcpu%2Ftorch-2.7.1%2Bcpu-cp39-cp39-manylinux_2_28_x86_64.whl&from=https%3A%2F%2Fgitcode.com%2FAscend%2Fpytorch%2Fblob%2Fv2.7.1%2Fdocs%2Fzh%2Finstallation_guide%2Finstallation_via_binary_package.md&lang=zh&theme=white) pip3 install torch-2.7.1+cpu-cp39-cp39-manylinux_2_28_x86_64.whl  # 下载并安装torch_npu插件 wget https://gitcode.com/Ascend/pytorch/releases/download/v26.0.0-pytorch2.7.1/torch_npu-2.7.1.post4-cp39-cp39-manylinux_2_28_x86_64.whl pip3 install torch_npu-2.7.1.post4-cp39-cp39-manylinux_2_28_x86_64.whl |
