...
smoke_test_samples() {
    ...
    run_pair "GLOO_SOCKET_IFNAME=enp67s0f5 HCCL_INTRA_ROCE_ENABLE=1 python3 hixl_tranfer_backend_sample.py --device_id 0 --role p --local_host_ip 127.0.0.1 --remote_host_ip 127.0.0.1" "GLOO_SOCKET_IFNAME=enp67s0f5 HCCL_INTRA_ROCE_ENABLE=1 python3 push_blocks_sample.py --device_id 1 --role d --local_host_ip 127.0.0.1 --remote_host_ip 127.0.0.1"
