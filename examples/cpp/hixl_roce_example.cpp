...
int32_t RunClient(const char *local_engine, const char *remote_engine, const char *transfer_mode, bool is_client) {
...
int32_t RunServer(const char *local_engine, const char *transfer_mode, bool is_client) {
...
int main(int32_t argc, char **argv) {
  ...
  bool is_client = (local_engine.find(':') == std::string::npos);
