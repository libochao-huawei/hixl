...
main() {
    ...
    run_pair "HCCL_INTRA_ROCE_ENABLE=1 ./client_server_h2d 0 127.0.0.1 127.0.0.1:16000" "HCCL_INTRA_ROCE_ENABLE=1 ./client_server_h2d 1 127.0.0.1:16000"
    run_pair "HCCL_INTRA_ROCE_ENABLE=1 ./server_server_d2d 0 127.0.0.1:16000 127.0.0.1:16001" "HCCL_INTRA_ROCE_ENABLE=1 ./server_server_d2d 1 127.0.0.1:16001 127.0.0.1:16000"
    if [ "$flag" -eq "0" ]; then
