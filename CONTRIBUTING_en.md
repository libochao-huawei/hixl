...
2. Before committing code using Git, refer to [pre-commit Usage Guide](docs/precommit_guide.md)​ to ensure that your submissions are compliant and efficient.
