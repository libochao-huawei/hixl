...
[![WeChat](https://img.shields.io/badge/contact_us-WeChat-blue)](https://gitcode.com/cann/hixl/blob/master/docs/figures/HIXL_contact.png)
...
- Mar 2026: HIXL supported FabricMem for SuperPoDs. For details, see [FabricMem](docs/FabricMem.md).
...
<img src="docs/figures/perf.png" alt="Performance data">
...
- [Build](docs/build.md): describes how to build and install the component, including how to use tests to perform local verification after the successful build.
...
- [C/C++ APIs](docs/cpp/README.md): describes the C++ APIs.
- [Python APIs](docs/python/README.md): describes Python APIs.
