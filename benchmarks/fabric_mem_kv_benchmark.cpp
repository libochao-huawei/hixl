...
void FinalizeBenchmark(AdxlEngine &engine, int rank, int world_size,
...
int main(int argc, char **argv) {
  ...
  if (!ExchangeHostAddrsAndConnect(engine, args.rank, args.world_size, args.sync_dir, peer_engines, host_pool,
                                   peer_host_va)) {
    FinalizeBenchmark(engine, args.rank, args.world_size, peer_engines, mem_host_handle, va, pa_handle, host_raw,
