...
def parse_all_benchmark_args() -> argparse.Namespace:
    ...
    parser.add_argument('--device_ids', type=str, default='0,1,2,3,4,5,6,7', help='Device IDs (default: 0-7). First 2 used for comm; KV uses all listed IDs (default 8 ranks on A2/A3/A5).')
